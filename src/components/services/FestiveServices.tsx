...
const FestiveServices: React.FC = () => {
  ...
  const festivePackages = [
    {
      ...
      price: "₹50,000+",
      features: ["Home decorations", "Traditional sweets", "Photography", "Cultural activities", "100 guests", "Half day celebration"],
      popular: false
    },
    {
      name: "Community Celebration",
      price: "₹1,50,000+",
      features: ["Venue decorations", "Cultural programs", "Traditional food stalls", "Entertainment", "300 guests", "Full day festival"],
      popular: true
    },
    {
      name: "Grand Festival",
      price: "₹3,00,000+",
      features: ["Premium venue", "Multiple cultural programs", "Food courts", "Live entertainment", "500+ guests", "Multi-day celebration"],
      popular: false
    }
  ];
    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-screen overflow-hidden">
        <div className="absolute inset-0 w-full h-full">
          ...
          >
            <source src={festive} type="video/mp4" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Authentic festival celebrations that bring communities together and honor cultural traditions
            </p>
          </div>
      ...
      {/* <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Celebrate festivals with authentic traditions and modern conveniences
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {festivePackages.map((pkg, index) => (
              <div
                key={index}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white/90 max-w-3xl mx-auto">
              Vibrant moments from our colorful festival celebrations
            </p>
          </div>
...
export default FestiveServices;